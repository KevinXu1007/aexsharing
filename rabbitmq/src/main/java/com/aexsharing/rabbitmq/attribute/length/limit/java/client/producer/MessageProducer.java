 ...
 * 作者姓名           修改时间           版本号              描述
 */
package com.aexsharing.rabbitmq.attribute.length.limit.java.client.producer;

import com.rabbitmq.client.AMQP;
import com.rabbitmq.client.BuiltinExchangeType;
import com.rabbitmq.client.Channel;
import com.aexsharing.rabbitmq.attribute.length.limit.java.client.utils.ChannelUtils ;
...
public class MessageProducer {
    public static void main(String[] args) throws IOException {
        ...
        channel.queueDeclare("aex.order.add", true, false, false, queueProperties);
        ...
        channel.basicPublish("aex.order", "add", false, basicProperties, "订单信息2".getBytes());
        channel.basicPublish("aex.order", "add", false, basicProperties, "订单信息3".getBytes());
    }
}