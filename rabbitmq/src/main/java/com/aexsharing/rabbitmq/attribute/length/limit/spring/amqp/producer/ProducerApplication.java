 ...
 * 作者姓名           修改时间           版本号              描述
 */
package com.aexsharing.rabbitmq.attribute.length.limit.spring.amqp.producer;
 ...
 * @since 1.0.0
 */
@ComponentScan(basePackages = "com.aexsharing.rabbitmq.attribute.length.limit.spring.amqp.producer")
public class ProducerApplication {
    public static void main(String[] args) {
        AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(com.aexsharing.rabbitmq.attribute.time.to.live.spring.amqp.producer.ProducerApplication.class);
        ...
        rabbitAdmin.declareQueue(new Queue("aex.order.add", true, false, false, queueProperties));
        rabbitAdmin.declareExchange(new DirectExchange("aex.order", true, false, new HashMap<>()));
        rabbitAdmin.declareBinding(new Binding("aex.order.add", Binding.DestinationType.QUEUE, "aex.order", "add", new HashMap<>()));
        ...
        rabbitTemplate.send("aex.order", "add", message2, new CorrelationData("201210704116"));
        ...
        rabbitTemplate.send("aex.order", "add", message3, new CorrelationData("201210704116"));
    }
}