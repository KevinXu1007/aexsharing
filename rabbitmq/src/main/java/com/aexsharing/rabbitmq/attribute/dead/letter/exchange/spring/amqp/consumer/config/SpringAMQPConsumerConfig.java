 ...
 * 作者姓名           修改时间           版本号              描述
 */
package com.aexsharing.rabbitmq.attribute.dead.letter.exchange.spring.amqp.consumer.config;
...
public class SpringAMQPConsumerConfig {
    ...
    public List<Queue> queueList() {
        ...
        Queue queue = new Queue("aex.order.add", true, false, false, queueProperties);
    ...
    public List<Exchange> exchangeList() {
        ...
        DirectExchange directExchange = new DirectExchange("aex.order", true, false, new HashMap<>());
