 ...
 * 作者姓名           修改时间           版本号              描述
 */
package com.aexsharing.rabbitmq.attribute.time.to.live.java.client.producer;

import com.rabbitmq.client.AMQP;
import com.rabbitmq.client.BuiltinExchangeType;
import com.rabbitmq.client.Channel;
import com.aexsharing.rabbitmq.attribute.time.to.live.java.client.utils.ChannelUtils;
...
public class MessageProducer {
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        channel.basicPublish("aex.order", "add", false, basicProperties2, "订单信息".getBytes());
    }
}