 ...
 * 作者姓名           修改时间           版本号              描述
 */
package com.aexsharing.rabbitmq.attribute.priority.queue.spring.amqp.consumer.config;
...
public class SpringAMQPConsumerConfig {
    ...
    public Queue queue() {
        ...
        return new Queue("aex.order.add", true, false, false, queueProperties);
    }
    ...
    public Binding binding() {
        return BindingBuilder.bind(new Queue("aex.order.add")).to(new DirectExchange("aex.order")).with("add");
    }
