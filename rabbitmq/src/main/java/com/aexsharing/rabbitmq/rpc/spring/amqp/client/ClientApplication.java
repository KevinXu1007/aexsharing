 ...
 * 作者姓名           修改时间           版本号              描述
 */
package com.aexsharing.rabbitmq.rpc.spring.amqp.client;
 ...
 * @since 1.0.0
 */
@ComponentScan("com.aexsharing.rabbitmq.rpc.spring.amqp.client")
public class ClientApplication {
    public static void main(String[] args) {
        ...
        Message messageReturn = rabbitTemplate.sendAndReceive("aex.order", "add", message, new CorrelationData("201210704116"));
