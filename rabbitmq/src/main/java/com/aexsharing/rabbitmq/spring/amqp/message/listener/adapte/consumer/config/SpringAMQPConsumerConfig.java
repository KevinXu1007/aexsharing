 ...
 * 作者姓名           修改时间           版本号              描述
 */
package com.aexsharing.rabbitmq.spring.amqp.message.listener.adapte.consumer.config;
...
import com.aexsharing.rabbitmq.spring.amqp.message.listener.adapte.consumer.handle.MessageHandle;
...
public class SpringAMQPConsumerConfig {
    ...
    public MessageListenerContainer messageListenerContainer(ConnectionFactory connectionFactory) {
        ...
        // 将aex.order.add队列的消息 使用add方法进行处理
