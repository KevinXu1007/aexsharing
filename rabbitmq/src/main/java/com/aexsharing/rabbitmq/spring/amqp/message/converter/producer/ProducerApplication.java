 ...
 * 作者姓名           修改时间           版本号              描述
 */
package com.aexsharing.rabbitmq.spring.amqp.message.converter.producer;
 ...
 * @since 1.0.0
 */
@ComponentScan(basePackages = "com.aexsharing.rabbitmq.spring.amqp.message.converter.producer")
