 ...
 * 作者姓名           修改时间           版本号              描述
 */
package com.aexsharing.rabbitmq.spring.amqp.annotation.producer;
 ...
 * @since 1.0.0
 */
@ComponentScan(basePackages = "com.aexsharing.rabbitmq.spring.amqp.annotation.producer")
public class ProducerApplication {
    public static void main(String[] args) {
        ...
        rabbitTemplate.send("aex.order", "", message);
    }
}