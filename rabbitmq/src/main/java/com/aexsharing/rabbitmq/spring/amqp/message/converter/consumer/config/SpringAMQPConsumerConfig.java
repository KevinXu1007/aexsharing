 ...
 * 作者姓名           修改时间           版本号              描述
 */
package com.aexsharing.rabbitmq.spring.amqp.message.converter.consumer.config;
...
import com.aexsharing.rabbitmq.spring.amqp.message.converter.consumer.converter.FileMessageConverter;
import com.aexsharing.rabbitmq.spring.amqp.message.converter.consumer.converter.StringMessageConverter;
import com.aexsharing.rabbitmq.spring.amqp.message.converter.consumer.entity.Order;
import com.aexsharing.rabbitmq.spring.amqp.message.converter.consumer.handle.MessageHandle;
...
public class SpringAMQPConsumerConfig {
    ...
    public MessageListenerContainer messageListenerContainer(ConnectionFactory connectionFactory) {
        ...
        queueOrTagToMethodName.put("aex.order.add","add");
