 ...
 * 作者姓名           修改时间           版本号              描述
 */
package com.aexsharing.rabbitmq.spring.amqp.manual.declare.consumer;
 ...
 * @since 1.0.0
 */
@ComponentScan(basePackages = "com.aexsharing.rabbitmq.spring.amqp.manual.declare.consumer")
public class ConsumerApplication {
    public static void main(String[] args) {
        ...
        rabbitAdmin.declareQueue(new Queue("aex.order.add", true, false, false, new HashMap<>()));
        ...
        rabbitAdmin.declareBinding(BindingBuilder.bind(new Queue("aex.order.add")).to(new DirectExchange("aex.order")).with("add"));
