package com.aexsharing.redis.dao.impl;
...
public class CommonRedisDaoImpl implements CommonRedisDao {
     ...
     * 前缀
     */
    private static final String KEY_PREFIX_VALUE = "com:aexsharing:value:";
    private static final String KEY_PREFIX_SET = "com:aexsharing:set:";
    private static final String KEY_PREFIX_LIST = "com:aexsharing:list:";
