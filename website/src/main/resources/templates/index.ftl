...
<head>
    ...
    <link rel="icon" href="http://image.aexsharing.com/logo/logo.png">
    <title>aexsharing</title>
...
<div class="header">
    <nav class="bg-faded ">
        ...
        <div class="collapse navbar-toggleable-xs" id="exCollapsingNavbar2" style="padding-left: 300px">
            <a class="navbar-brand" href="#" style="color: white">aexsharing.com</a>
            <ul class="nav navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link navbar-color active" href="#">首页 <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link navbar-color" href="http://blog.aexsharing.com">博客</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link navbar-color" href="https://aexsharing.com">关于</a>
                </li>
            </ul>
        <#if currentUser??>
        ...
        <#else>
            <ul class="nav navbar-nav pull-right" style="padding-right:50px">
                ...
                <li class="nav-item">
                    <a class="nav-link navbar-color" href="toRegister">注册</a>
                </li>
            </ul>
        </#if>
...
<footer>
    <div class="footer">
        <h5>Copyright © 2018-2019 aexsharing AllRight Reversed</h5>
        <h6><a href="https://myshanring.com" target="_blank">京ICP备15009606号</a></h6>
    </div>
</footer>
